...
% Hard skill bars
\programming{{C $\textbullet$ HCL  $\textbullet$ Go / 3}, {Bash $\textbullet$ Python $\textbullet$  Lua / 5}, {Terraform $\textbullet$ AWS $\textbullet$ Ansible / 5}, {Github Actions $\textbullet$ Jenkins $\textbullet$ Docker / 3.5}}
