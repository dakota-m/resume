...
% Hard skill bars
\programming{{C $\textbullet$ C++  $\textbullet$ Embedded / 3}, {Bash $\textbullet$ Python $\textbullet$  Go / 5}, {Terraform $\textbullet$ AWS $\textbullet$ Ansible / 5}, {Github Actions $\textbullet$ Jenkins $\textbullet$ Buddy / 3.5}}
...
\cvjobtitle{ DevOps Engineer III } % Job
% title/career
\profilepic{img/dakotamartin.jpg} % Profile picture
\cvdate{Lehi, UT}
...
\begin{twenty} % Environment for a list with descriptions
	...
	{\begin{itemize}
		...
		\item Production server provisioning using MAAS
		\end{itemize}}
	\\
	\twentyitem
	{Jun 2021 -}
