...
% Hard skill bars
\programming{{C $\textbullet$ C++  $\textbullet$ Embedded / 3}, {Bash $\textbullet$ Python $\textbullet$  Go / 5}, {Terraform $\textbullet$ AWS $\textbullet$ Ansible / 5}, {Github Actions $\textbullet$ Jenkins $\textbullet$ Docker / 3.5}}
